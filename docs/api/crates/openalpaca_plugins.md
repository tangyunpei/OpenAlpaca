...
- Member path: `crates/openalpaca_plugins`
- Entry: `crates/openalpaca_plugins/src/lib.rs`

## Modules

- `bridge` (crates/openalpaca_plugins/src/bridge/mod.rs)
- `config_codec` (crates/openalpaca_plugins/src/config_codec.rs)
...
- `process_pool` (crates/openalpaca_plugins/src/process_pool.rs)
- `stdio_channel` (crates/openalpaca_plugins/src/stdio_channel.rs)
