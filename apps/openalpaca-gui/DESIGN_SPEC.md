...
| `Reconnect` / `Copy log path`                         | Settings connection buttons with no handler _(Shipped: both wired — a re-bootstrap plus a socket reopen, and `GET /v1/status.log_path`, inert with the reason when it is `null`.)_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
