...
| `Add provider` / `Connect service` / `Install plugin` | Only toast a placeholder _(Shipped: `Install plugin` became `Add extension` and is real — plugin or MCP server, with a dry run. `Add provider` still toasts: the key editor is not built. `Connect service` still toasts: no route adds a connector, GAP-17.)_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `Manage providers & keys ↗`                           | Navigates, but the target section has no key-entry UI _(Still true of the shipped section: keys are counted, not edited — `openalpaca llm keys …` manages them.)_                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
