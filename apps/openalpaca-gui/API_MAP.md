...
| messages of one conversation                                            | ✅ `GET /v1/conversations/{id}/messages?limit&offset` → `{ messages: ConversationMessage[], total: i64 }` — the same rows as `/v1/chat/history`, `task_id` and `artifacts` included (GAP-23)                                                                                                                                                                                                                                                                                                                                                                                  |                                                                                                                                                                                                                                                  |
