//! Automatic user trait extraction from conversation turns.
//!
//! Extracts user traits via LLM and persists them to USER.md (profile) or
//! Memory v2 (situational preferences).
...
impl Orchestrator {
    ...
    pub(crate) async fn maybe_extract_user_traits(
        &self,
        lane_key: &str,
        user_message: &str,
