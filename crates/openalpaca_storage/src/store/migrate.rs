//! Moving a current project store without merging or overwriting another store.
...
// ============================================================================
// The project store move (§4.8, "Project moved")
// ============================================================================
...
pub enum StoreMove {
    ...
    /// its owner can answer, so this refuses rather than choose.
    Ambiguous,
